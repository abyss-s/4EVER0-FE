  ...
  return (
    <div className="absolute top-0 left-0 right-0 z-10 p-3">
      <div className="relative w-full max-w-2xl mx-auto">
        <div className="absolute inset-0 bg-gradient-to-r from-brand-red-light via-brand-yellow-light to-brand-darkblue-light rounded-xl blur-sm"></div>

        <Card className="relative w-full border-0 bg-gradient-to-r from-brand-red-light/90 via-brand-yellow-light/90 to-brand-darkblue-light/90 backdrop-blur-sm shadow-lg">
          <CardHeader className="pb-2">
            <div className="flex items-center justify-between mb-2">
              <div className="flex items-center gap-2">
                ...
                <div className="text-sm font-bold text-brand-darkblue">{currentUBTIStep + 1}/4</div>
              </div>
              ...
              {ubtiReadyToSubmit && (
                <button
                  ...
                  className="px-4 py-2 rounded-lg bg-gradient-to-r from-brand-yellow to-brand-red text-white font-semibold shadow-md hover:shadow-lg transition-all duration-300 transform hover:scale-105"
                >
                  🎉 결과 보기
                </button>
              )}
                    ...
                    <div
                      className={cn(
                        ...
                        index <= currentUBTIStep
                          ? 'bg-white text-brand-darkblue border border-brand-darkblue'
                          : 'bg-white/30 text-brand-darkblue/50',
                      )}
                    >
          ...
          <CardContent className="pt-0 pb-3">
            ...
            <p className="text-brand-darkblue/80 text-xs mt-2 text-center">
              💬 아래 채팅창에서 답변해주세요!
            </p>
          </CardContent>
        </Card>
