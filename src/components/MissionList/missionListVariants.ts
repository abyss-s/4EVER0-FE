...
//       spacing: {
//         tight:
//           '[&>*:not(:last-child)]:border-b [&>*:not(:last-child)]:border-gray-100 dark:[&>*:not(:last-child)]:border-gray-700',
//         normal:
//           '[&>*:not(:last-child)]:border-b [&>*:not(:last-child)]:border-gray-100 dark:[&>*:not(:last-child)]:border-gray-700 [&>*]:py-4 first:[&>*]:pt-0 last:[&>*]:pb-0',
//         loose:
...
// export const missionItemVariants = cva('flex items-center gap-4 transition-colors duration-200', {
//   variants: {
//     interactive: {
//       true: 'hover:bg-gray-50 dark:hover:bg-gray-700/50 cursor-pointer rounded-lg p-2 -m-2',
//       false: '',
//     },
//     completed: {
//       true: 'opacity-60',
...
//   'flex items-center justify-center flex-shrink-0 rounded-lg overflow-hidden',
//   {
//     variants: {
//       size: {
//         sm: 'w-10 h-10',
